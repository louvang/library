...
class Book {
  constructor(author, title, pageCt, completed) {
    this.author = author;
    this.title = title;
    this.pageCt = pageCt;
...
const updateLibrary = function updateLibrary() {
...
document.getElementById('save-book-btn').addEventListener('click', editBook);

document.getElementById('confirm-delete-btn').addEventListener('click', deleteBook);
